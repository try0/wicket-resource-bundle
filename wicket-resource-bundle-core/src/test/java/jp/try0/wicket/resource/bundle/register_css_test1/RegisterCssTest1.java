...
public class RegisterCssTest1 extends AbstractResourceBundleTest {
	...
	public void registerCssResources() {
		...
		Assertions.assertFalse(manager.isJsHolderClass(TestComponent_registerResources1.class));
		Assertions.assertFalse(manager.isJsHolderClass(TestComponent_registerResources2.class));
